...
// 0 out = LED on
// 1 out = LED off
#define LED_R_OFF_MSK	(GPIO_BSRR_BR_5)	
#define LED_R_ON_MSK	(GPIO_BSRR_BS_5)
#define LED_G_OFF_MSK	(GPIO_BSRR_BR_6)
#define LED_G_ON_MSK	(GPIO_BSRR_BS_6)
#define LED_B_OFF_MSK	(GPIO_BSRR_BR_7)
#define LED_B_ON_MSK	(GPIO_BSRR_BS_7)
...
void Control_RGB_LEDs_0(int r_on, int g_on, int b_on); // Nigel added due to warning
#endif
